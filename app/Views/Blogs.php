    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="<?= base_url('blogs'); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="col-12">
                <div class="card my-4 mx-4">
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card-pr h-100 ">
                                        ...
                                        <div class="card-body mt-1 px-2 py-2 text-center">
                                            ...
                                            <!-- <button type="button" class="btn btn-dark bg-gradient-secondary btn-sm edit-btn" data-toggle="modal" data-target="#Modeleditblog" data-id="<?= $blog['id']; ?>" data-title="<?= $blog['title']; ?>" data-description="<?= $blog['description']; ?>">Edit</button> -->
                                            <button type="button" class="btn btn-dark bg-gradient-secondary btn-sm edit-btn"
                            data-id="<?= $blog['id']; ?>" data-name="<?= $blog['title']; ?>"
                            data-description="<?= $blog['description']; ?>"   data-toggle="modal" data-target="#Modeleditblog">Edit</button>
                                            <a href="<?= base_url('delBlog/' . $blog['id']); ?>"
                                                onclick="return confirm('Are You sure you want to delete this project')"
                                                class="btn btn-primary btn-sm" data-target=".Model-blog">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <div class="modal fade " id="Modeleditblog" tabindex="-1" role="dialog"
                            aria-labelledby="mySmallModalLabel">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            <form role="form" action="<?=base_url('editB');?>" method="post"
                                                enctype="multipart/form-data">
                                                <input type="hidden" name="id" id="edit-id">
                                                <div class="input-group input-group-outline mb-3">
                                                    <!-- <label>Profile</label> -->
                                                    <input type="file" name="image" placeholder="Profile"
                                                        class="form-control" id="edit-img">
                                                </div>
                                                <div class="input-group input-group-outline mb-3">
                                                    <!-- <label class="form-label">Title</label> -->
